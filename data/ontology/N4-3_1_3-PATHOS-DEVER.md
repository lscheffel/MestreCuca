# N4-3_1_3 - PATHOS / DEVER - Células Semânticas

---

## Metadados

- **ID N4:** 3.1.3 (agregado)
- **ID N3 Pai:** 3.1.3
- **ID N2 Avô:** 3.1
- **Domínio:** PATHOS
- **Subdomínio N3:** DEVER
...
Este arquivo agrega as células semânticas operacionais N4 derivadas do subdomínio N3 **DEVER** (PATHOS), conforme mapeamento na Taxonomia Ontológica.

**Origem N3:** `N3-3_1_3-PATHOS-DEVER.md`  
...
| Elemento | Referência |
|----------|------------|
| Arquivo N3 | `N3-3_1_3-PATHOS-DEVER.md` |
| Domínio N2 | 3.1_DEVER |
| Domínio N1 | PATHOS |
...
- **ID:** P3.1.3-A
- **Gatilho:** Cumprir obrigação moral
- **Ação:** Agir conforme dever
- **Restrição:** Não negligenciar responsabilidade
- **Verificação:** Dever cumprido

### 2. CONSEQUÊNCIA

- **ID:** P3.1.3-B
- **Gatilho:** Avaliar impacto das ações
- **Ação:** Antecipar resultados
- **Restrição:** Não ignorar efeitos colaterais
- **Verificação:** Consequências consideradas

### 3. ESCOLHA

- **ID:** P3.1.3-C
- **Gatilho:** Decidir entre alternativas
- **Ação:** Ponderar valores em conflito
- **Restrição:** Não decidir precipitadamente
- **Verificação:** Escolha alinhada com valores
